...
const handleClick = async (e) => {
  ...
  try {
    ...
    if (files.length > 0) {
      ...
      updatedUser.img = "https://cdn.tresorit.com/webv10/dist/img/landings/features/icons/icon-file-sharing.3802e9ca.png"; // Borrar la URL de la imagen si no se han agregado nuevas imágenes
    }
